        ...
        row.innerHTML = `
            ...
            <td>
                ...
                <div class="status-dropdown-container">
                    <button class="action-btn status-btn" data-id="${caseItem.id}"><i class="fas fa-sync-alt"></i> Estado</button>
...
function setupEventListeners() {
    ...
    document.addEventListener('click', function(e) {
       ...
       // Nueva lógica para el botón "Estado"
        if (e.target.closest('.status-btn')) {
            ...
            e.stopPropagation(); // Previene que el clic se propague y cierre el menú inmediatamente
        }

        // Lógica para seleccionar una opción del menú
        if (e.target.closest('.status-dropdown .dropdown-item')) {
         ...
         // Lógica para cerrar el menú si se hace clic en cualquier otro lugar
    ...
    // Lógica del menú desplegable de Finanzas
    const finanzasMenuItem = document.getElementById('finanzas-menu-item');
    if (finanzasMenuItem) {
        finanzasMenuItem.addEventListener('click', function(event) {
